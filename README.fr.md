...
Clonez le depot et creez le venv :
...
Sous Windows, utilisez `.venv\Scripts\python.exe` au lieu de `.venv/bin/python3`.

Le serveur expose 23 outils prefixes `debug_` — n'importe quel client MCP peut les utiliser.
